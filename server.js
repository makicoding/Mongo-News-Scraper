...
var logger = require("morgan");     // This makes HTTP calls
...
// Port configuration for Heroku & Local
  ...
  axios.get("https://www.nytimes.com").then(function(response) {
    ...
    $("article").each(function(i, element) {
      ...
      db.Article.create(result)
        ...
        // Once scraping is complete, go back to the root directory
        // .then(function(goBackToRootDirectory){
...
Mongoose is an ORM (Object-Relational Mapping) for Mongo DB. It is the Mongo DB equivalent of Sequelize for MySQL.
...
Cheerio is an NPM package that enables use of jQuery as a server side language.
...
Then type in the following to do the initial scraping from the news site.  To scrape again, type the following again also:
